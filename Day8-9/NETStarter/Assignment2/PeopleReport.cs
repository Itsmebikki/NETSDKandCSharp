class PeopleReport
{
    ...
    {
        string filePath=@"D:\Traineeship\NETSDKandCSharp\Day8-9\NETStarter\PeopleManagement\Data\males.csv";
    ...
    {
        string filePath = @"D:\Traineeship\NETSDKandCSharp\Day8-9\NETStarter\PeopleManagement\Data\adultfemales.csv";
    ...
    {
        string filePath = @"D:\Traineeship\NETSDKandCSharp\Day8-9\NETStarter\PeopleManagement\Data\dotcomusers.csv";
